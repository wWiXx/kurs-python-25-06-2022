...
print(sumOfCalories)
print(
    f"{tomato:<15}, kalorie:{tomatoCountedCalories:7.2f}, b: {tomatoCountedProteins:5.2f}, t: {tomatoCountedFat:5.2f},\
 w: {tomatoCountedCarbo:5.2f}, waga: {str(tomatoWeight) + ' g':5}, koszt: {str(tomatoCountedPrice):<5} {currency}"
)
print(
    f"{mozzarella:<15}, kalorie:{mozzarelaCountedCalories:7.2f}, b: {mozzarellaCountedProteins:5.2f}, t: {mozzarelaCountedFat:5.2f},\
 w: {mozzarellaCountedCarbo:5.2f}, waga: {str(mozzarellaWeight) + ' g':5}, koszt: {str(mozzarellaCountedPrice):<5} {currency}"
)
print(
    f"{salad:<15}, kalorie:{saladCountedCalories:7.2f}, b: {saladCountedProteins:5.2f}, t: {saladCountedFat:5.2f}, \
...
print(
    f"{sum:<15}, kalorie:{sumOfCalories:7.2f}, b: {sumOfProteins:5.2f}, t: {sumOfFats:5.2f}, w: {sumOfCarbos:5.2f},\
